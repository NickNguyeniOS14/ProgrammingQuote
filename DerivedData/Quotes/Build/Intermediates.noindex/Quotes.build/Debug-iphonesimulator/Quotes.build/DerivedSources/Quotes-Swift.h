...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Quotes",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6Quotes32FavoriteQuoteTableViewController")
@interface FavoriteQuoteTableViewController : UITableViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC6Quotes9QuoteCell")
...
SWIFT_CLASS("_TtC6Quotes29QuoteCollectionViewController")
@interface QuoteCollectionViewController : UICollectionViewController <UICollectionViewDelegateFlowLayout>
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
@interface QuoteCollectionViewController (SWIFT_EXTENSION(Quotes)) <UNUserNotificationCenterDelegate>
- (void)userNotificationCenter:(UNUserNotificationCenter * _Nonnull)center didReceiveNotificationResponse:(UNNotificationResponse * _Nonnull)response withCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
@end


SWIFT_CLASS("_TtC6Quotes22QuotesTabBarController")
@interface QuotesTabBarController : UITabBarController
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC6Quotes13SceneDelegate")
